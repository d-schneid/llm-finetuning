...
if __name__ == '__main__':
	...
	file_path = "./data/Code/main/data_preprocessing/data/huawei/code_text/train/samples_0.h5"

	with open('./data/Code/main/data_preprocessing/data/huawei/code_text/train/num_samples_0.json', 'r') as f:
		data = json.load(f)
